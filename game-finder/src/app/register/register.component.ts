...
export class RegisterComponent {
  ...
  // Populate the list of time zones
  populate_timeZones() {
    this.timeZones =
    [
  ...
  // Get the default time zone based on the user's system time
  ...
  signup(username: string, displayname: string, password: string, email: string) {
    ...
    fetch(this.ip + "SignIn?Username=" + username
  ...
  // Sign up with standard registration
  // (Was going to implement other form of signup such as Google Signup)
  signupStandard() {
  ...
  completeRegistration() {
    ...
    // Set profile variable: privacyLvl
    ...
    // Set profile variable: availableTime
    fetch(this.ip + "SetProfileVar?Username=" + this.username
    ...
    // Set profile variable: Time Zone
    fetch(this.ip + "SetProfileVar?Username=" + this.username
      + "&ReqVar=" + "timezone"
    ...
    // Set profile variable: Profile Picture
    fetch(this.ip + "SetProfileVar?Username=" + this.username
      + "&ReqVar=" + "pfp"
